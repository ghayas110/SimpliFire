...
import { Upload, Plus, Trash2, Tag, Info, Image as ImageIcon, X, FolderPlus, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function AdminAddProductPage() {
  ...
  const handleSave = async () => {
    ...
    if (error) {
      setNotification({ type: 'error', message: "Error creating product: " + error.message });
    } else {
  ...
  return (
    <div className="space-y-8 relative font-sans">
      ...
      <div>
        <h1 className="text-3xl font-light tracking-tight text-neutral-900 mb-2">Add New Product</h1>
        <p className="text-neutral-500 text-sm">Create a new product listing into Supabase.</p>
      </div>
